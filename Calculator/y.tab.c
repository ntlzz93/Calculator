...
{
       0,   189,   189,   190,   194,   197,   198,   199,   202,   203,
     204,   213,   216,   217,   220,   221,   222,   223,   224,   232,
     233,   234,   235,   236
};
#endif
...
{
  "$end", "error", "$undefined", "NUM", "FUNC1", "FUNC2", "POW", "EOL",
  "'+'", "'-'", "'*'", "'/'", "'%'", "'('", "')'", "'|'", "'{'", "'}'",
  "'['", "']'", "'!'", "','", "$accept", "S", "E", "T", "P", "F", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
      ...
      42,    47,    37,    40,    41,   124,   123,   125,    91,    93,
      33,    44
};
# endif
...
{
     -10,     9,   -10,   -10,    25,    -9,   -10,    41,    41,    41,
      41,    41,    68,    69,   -10,    -1,    41,    -5,    41,    -5,
      39,    27,    43,    -2,   -10,    41,    41,    41,    41,    41,
      41,   -10,    53,    12,   -10,   -10,   -10,   -10,    69,    69,
     -10,   -10,   -10,   -10,   -10,    41,    55,   -10
};
...
{
       2,     0,     1,    23,     0,     0,     4,     0,     0,     0,
       0,     0,     0,     7,    11,    13,     0,    22,     0,    19,
       0,     0,     0,     0,     3,     0,     0,     0,     0,     0,
       0,    18,     0,     0,    14,    15,    16,    17,     5,     6,
       8,     9,    10,    12,    14,     0,     0,    20
};
...
{
      20,    21,    22,    23,    18,    30,    25,    26,    32,     2,
      33,     0,     3,     4,     5,    31,     6,    37,     7,    31,
      25,    26,     8,    17,     9,    10,    19,    11,     3,     4,
       5,    38,    39,    45,     7,    25,    26,    46,    16,     0,
       9,    10,    35,    11,     3,     4,     5,    25,    26,     0,
       7,    25,    26,    34,     8,     0,     9,    10,     0,    11,
      36,    25,    26,    25,    26,     0,     0,    44,     0,    47,
       0,    40,    41,    42,    43,    24,    25,    26,     0,    27,
      28,    29
};

static const yytype_int8 yycheck[] =
{
       8,     9,    10,    11,    13,     6,     8,     9,    16,     0,
      18,    -1,     3,     4,     5,    20,     7,    19,     9,    20,
       8,     9,    13,     4,    15,    16,     7,    18,     3,     4,
       5,    25,    26,    21,     9,     8,     9,    45,    13,    -1,
      15,    16,    15,    18,     3,     4,     5,     8,     9,    -1,
       9,     8,     9,    14,    13,    -1,    15,    16,    -1,    18,
      17,     8,     9,     8,     9,    -1,    -1,    14,    -1,    14,
      -1,    27,    28,    29,    30,     7,     8,     9,    -1,    10,
      11,    12
};
...
{
       0,    23,     0,     3,     4,     5,     7,     9,    13,    15,
      16,    18,    24,    25,    26,    27,    13,    27,    13,    27,
      24,    24,    24,    24,     7,     8,     9,    10,    11,    12,
       6,    20,    24,    24,    14,    15,    17,    19,    25,    25,
      26,    26,    26,    26,    14,    21,    24,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 190 "clac.y" /* yacc.c:1646  */
    { printf("= %4.4g\n", eval((yyvsp[-1].cal)));
  					write_graphviz((yyvsp[-1].cal));
				    deletesf((yyvsp[-1].cal));
				    printf("> ");}
#line 1421 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 194 "clac.y" /* yacc.c:1646  */
    {printf("> ");}
#line 1427 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 197 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = createOperation(Add,(yyvsp[-2].cal) ,(yyvsp[0].cal));}
#line 1433 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 198 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = createOperation(Sub,(yyvsp[-2].cal) ,(yyvsp[0].cal));}
#line 1439 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 199 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = (yyvsp[0].cal);}
#line 1445 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 202 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = createOperation(Mul,(yyvsp[-2].cal) ,(yyvsp[0].cal));}
#line 1451 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 203 "clac.y" /* yacc.c:1646  */
    {if((yyvsp[0].cal)->f==0){yyerror("Division by zero is undefined!");}else (yyval.cal) = createOperation(Div,(yyvsp[-2].cal) ,(yyvsp[0].cal));}
#line 1457 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 204 "clac.y" /* yacc.c:1646  */
    {
  					if((yyvsp[-2].cal)->f==(int)(yyvsp[-2].cal)->f && (yyvsp[0].cal)->f ==(int)(yyvsp[0].cal)->f)
  					{
  						(yyval.cal) = createOperation(Mod,(yyvsp[-2].cal) ,(yyvsp[0].cal));
  					}else 
  					{
...
#line 1471 "y.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 213 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = (yyvsp[0].cal);}
#line 1477 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 216 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = createOperation(Pow,(yyvsp[-2].cal) ,(yyvsp[0].cal));}
#line 1483 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 217 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = (yyvsp[0].cal);}
#line 1489 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 220 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = (yyvsp[-1].cal);}
#line 1495 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 221 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = createOperation(Abs,(yyvsp[-1].cal),NULL);}
#line 1501 "y.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 222 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = (yyvsp[-1].cal);}
#line 1507 "y.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 223 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = (yyvsp[-1].cal);}
#line 1513 "y.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 224 "clac.y" /* yacc.c:1646  */
    {
  					if((yyvsp[-1].cal)->f==(int)(yyvsp[-1].cal)->f)
	  				{
	  					if((yyvsp[-1].cal)>=0)(yyval.cal) = createOperation(Factorial,(yyvsp[-1].cal),NULL);
	  					else yyerror("Fail");
	  				}
...
#line 1526 "y.tab.c" /* yacc.c:1646  */
  ...
  case 19:
#line 232 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = createOperation(Nega,(yyvsp[0].cal) ,NULL);}
#line 1532 "y.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 233 "clac.y" /* yacc.c:1646  */
    {(yyval.cal)=createOperation((int)(yyvsp[-5].fc) ,(yyvsp[-3].cal) ,(yyvsp[-1].cal));}
#line 1538 "y.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 234 "clac.y" /* yacc.c:1646  */
    {(yyval.cal)=createOperation((int)(yyvsp[-3].fc) ,(yyvsp[-1].cal) ,NULL);}
#line 1544 "y.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 235 "clac.y" /* yacc.c:1646  */
    {(yyval.cal)=createOperation((int)(yyvsp[-1].fc) ,(yyvsp[0].cal) ,NULL);}
#line 1550 "y.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 236 "clac.y" /* yacc.c:1646  */
    {(yyval.cal) = createNumber((yyvsp[0].f));}
